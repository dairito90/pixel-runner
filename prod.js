...
var Box = function () {
    function Box(height, width, speed, y, x) {
...
function generateBox() {
    ...
    if (GAME_STATE === "runnig") setTimeout(generateBox, Math.floor(Math.random() * 3) * 1000);
}
generateBox();
...
},{"./box.js":1,"./detectCollision.js":2,"./player.js":4,"./scene.js":5}],4:[function(require,module,exports){
"use strict";
